...
export default function Service({
    ...
    const services = {
        commercial: {
            ...
            description: 'We help businesses maintain clean, safe, and welcoming workplaces through consistent, professionally managed cleaning services.',
            image: commercialImg,
            includes: [
                'Office cleaning',
            ...
            idealFor: 'Businesses seeking dependable, long-term cleaning support for offices and professional environments.'
        },
        accommodation: {
            id: 'accommodation',
            title: 'Accommodation Turnover Cleaning',
            subtitle: 'Guest-Ready Spaces, Every Time',
            description: 'We help property managers and hosts maintain guest-ready spaces with efficient, checklist-driven cleaning.',
            ...
            idealFor: 'Property managers, Airbnb hosts, and accommodation providers who need reliable turnover cleaning.'
        },
        hospitality: {
            id: 'hospitality',
            title: 'Hospitality Cleaning',
            subtitle: 'Excellence in Every Detail',
            description: 'We provide high-standard cleaning support for hospitality environments that require consistency, professionalism, and attention to detail.',
            ...
            idealFor: 'Hotels, hostels, and hospitality venues where presentation and consistency matter most.'
        },
        domestic: {
            id: 'domestic',
            title: 'Domestic & General Cleaning',
            subtitle: 'Making Everyday Living Easier',
            description: 'We support busy households with dependable cleaning services that make everyday living easier.',
            image: domesticImg,
            includes: [
            ...
            idealFor: 'Busy households looking for reliable cleaning services that create peace of mind.'
        }
    };

    const serviceOrder = ['commercial', 'accommodation', 'hospitality', 'domestic'];
        ...
        `}</style>
            ...
            <section className="relative pt-44 pb-20 px-6 text-white overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-[#C6A35A] mb-8 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                        Tailored to Your Needs
                    </p>
                    <p className="text-lg leading-relaxed max-w-3xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
                        At Talon Cleaning Services, we deliver reliable, detail-focused cleaning solutions tailored to businesses, property operators, and households. Our services are designed to maintain clean, healthy, and welcoming environments through consistent standards and professional management.
                    </p>
                </div>
            </section>
                ...
                {serviceOrder.map((serviceId, index) => {
                    ...
                    return (
                        <section
                            key={serviceId}
                            id={serviceId}
                            className={`mb-24 scroll-mt-32 ${selectedService === serviceId ? 'animate-fadeIn' : ''}`}
                        >
                            <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                                ...
                                <div className="flex-1">
                                    ...
                                    {/* Services Include */}
                                    <div className="mb-8">
                                        <h4 className="font-semibold text-[#0F2A44] text-xl mb-4">Services Include:</h4>
                                    ...
                                    {/* Benefits */}
                                    <div className="mb-8">
                                        <h4 className="font-semibold text-[#0F2A44] text-xl mb-4">Key Benefits:</h4>
                                        <ul className="space-y-3">
                                    ...
                                    <div className="bg-[#F7F6F2] p-6 rounded-lg border-l-4 border-[#C6A35A]">
                                        <p className="text-[#2E2E2E] italic">
                                            <strong className="text-[#0F2A44] not-italic">Ideal for:</strong> {service.idealFor}
                                        </p>
                                    </div>
